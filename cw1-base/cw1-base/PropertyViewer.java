...
{    
     ...
     * @param prop_no - property number to be displayed
     */
    public void displayProperty(int prop_no)
    {   
        current_property = (portfolio).getProperty(prop_no);
        gui.showProperty(current_property);                    //calling all the gui functions to display the property info on the window.
